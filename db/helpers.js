...
async function createCardsTable () {
    return await pool.query(  `CREATE TABLE cards (card_id INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY, week INTEGER, day TEXT, image TEXT,topic TEXT[],ref TEXT []);
